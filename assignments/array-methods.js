...
// let firstNamesAllCaps= runners.map(function(first_name){
...
let money= donations = runners.map( (runners) => {
  return runners.donation;
});
let ticketPriceTotal=money.reduce( (accumulator, CurrentValue) =>{
